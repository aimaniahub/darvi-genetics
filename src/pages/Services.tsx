    ...
    <div className="bg-white text-gray-900">
      <div className="h-screen flex flex-col justify-center px-6 md:px-20 max-w-[1600px] mx-auto relative z-10">
        ...
        >
          ...
          <span className="uppercase tracking-widest text-sm font-bold text-gray-500">Scroll to explore</span>
        </motion.div>
      </div>
        ...
        return (
          <section key={service.id} ref={ref} className="relative h-[120vh] flex items-center justify-center overflow-hidden">
            ...
            >
              ...
              <div className="w-full md:w-1/2 md:pl-12 border-l-0 md:border-l border-gray-200">
      ...
      <section className="py-32 bg-green-50 relative z-10 border-t border-green-100">
        <div className="max-w-[1600px] mx-auto px-6 md:px-20">
          <div className="mb-20">
            <h2 className="text-5xl md:text-7xl font-display font-bold uppercase tracking-tighter mb-6 text-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="p-10 border border-green-200 hover:border-primary/50 transition-colors group bg-white shadow-sm hover:shadow-md"
              >
                <div className="text-primary font-mono text-sm mb-8">0{i + 1}</div>
                <h3 className="text-3xl font-display font-bold uppercase tracking-tighter mb-4 group-hover:text-primary transition-colors text-gray-900">{benefit.title}</h3>
